...
Let $M$ be the $10 \times 10$ matrix s.t. $(M)_{i, j} = ij / 100$. $M$ is symmetric $\implies M^2$ is positive definite, so we can let $M^2$ be the target covariance. The top left entry is 1.0384. The mean of the square of the first coordinate of our MCMC runs should be 1.0384. Let's have a look at the target distn.
